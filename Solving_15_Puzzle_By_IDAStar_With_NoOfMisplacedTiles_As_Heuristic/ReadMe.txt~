This is implementation of IDA* Algorithm with Manhattan Distance as heursitic. The code will ask a input state of 15 puzzle. please type the state as continous characters with comma
